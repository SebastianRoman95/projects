...
template<typename T>
trapezoid<T>::trapezoid(const T& numX, const T& numY, const T& numX2, const T& numY2,
...
//copy
template<typename T>
trapezoid<T>::trapezoid(const trapezoid<T> &trapezoidToCopy){
}

//destructor
template<typename T>
trapezoid<T>::~trapezoid(){
    cout << "trapezoid destructor completed." <<endl;
}

//width 
template<typename T>
T trapezoid<T>::getWidthT(){
    double left=0;
    double right=0;
    left = abs(quadrilateral<T>::getNumX()-quadrilateral<T>::getNumX2());
    right = abs(quadrilateral<T>::getNumX3()-quadrilateral<T>::getNumX4());
    return left+right;
}

//height
template<typename T>
T trapezoid<T>::getHeightT(){
...
template<typename U>
istream &operator>>(istream &input, trapezoid<U> &a){
...
template<typename U>
ostream &operator<<(ostream &output, const trapezoid<U> &a){
