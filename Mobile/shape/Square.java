public class Square extends Quadrilateral{
    //var
    public Square(double numX, double numY, double numX2, double numY2, double numX3, double numY3, double numX4, double numY4){
    ...
    public String toString(){
        return String.format(super.toString(), "Side: ", getSide(), "Area: ", areaS());
    }
}
